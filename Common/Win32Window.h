...
#define WINDOWCLASS "WindowClass"
		...
		public:
			...
			bool IsFullScreen()  override; //imgui here
			void SetExtraMsgFunc(ExInputFunc func) { exInputFunc = func; }//imgui here
		...
		protected:
			...
			Vector2 fullscreenSize;//imgui here
			Vector2 defaultPosition;//imgui here
			ExInputFunc exInputFunc = nullptr;//imgui here 
		};
	}
}
#endif //_WIN32